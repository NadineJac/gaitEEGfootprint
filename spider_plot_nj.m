function spider_plot_nj(P, varargin)
...
edgeColors = repmat(edgeColors, repeat_colors, 1);
...
h = [text_handles; plot_handles;isocurve_handles; patch_handles];
